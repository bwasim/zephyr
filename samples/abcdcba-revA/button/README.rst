...
This sample is generically usable, given that the board has a button and an
led. Here we build it for the ABC board,

.. zephyr-app-commands::
   :zephyr-app: samples/abcdcba-samples/button
